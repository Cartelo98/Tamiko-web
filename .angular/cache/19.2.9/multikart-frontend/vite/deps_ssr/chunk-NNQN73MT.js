...
// node_modules/@ngx-loading-bar/core/fesm2015/ngx-loading-bar-core.mjs
    ...
    this.timer$ = (s) => {
      ...
      switch (s.action) {
        ...
        case "set": {
          ...
          if (this.requests > 0) {
            state$ = (0, import_rxjs.timer)(this.config.latencyThreshold, 250).pipe((0, import_operators.map)((t) => Object.assign(Object.assign({}, s), {
        ...
        case "complete":
        case "stop": {
          state$ = s.value === 0 ? (0, import_rxjs.of)(Object.assign({}, s)) : (0, import_rxjs.timer)(0, 500).pipe((0, import_operators.take)(2), (0, import_operators.map)((t) => ({
            value: t === 0 ? 100 : 0
          })));
          break;
        }
      }
      return state$.pipe((0, import_operators.map)((next) => Object.assign(Object.assign({}, next), {
        action: "set"
...
//# sourceMappingURL=chunk-NNQN73MT.js.map
